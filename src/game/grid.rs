...
impl Grid {
    ...
    pub fn set(&mut self, i: usize, j: usize, value: bool) -> Option<()> {
        *self.data.get_mut(i + self.width * j)? = value;
        Some(())
    }

    pub fn insert(&mut self, i: usize, j: usize, value: bool) {
        self.data.insert(i + self.width * j, value)
    }
